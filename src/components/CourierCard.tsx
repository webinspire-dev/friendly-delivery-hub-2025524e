...
const CourierCard = ({
  ...
  return (
    <div
      className="group relative bg-card rounded-2xl border border-border p-6 hover:border-primary/30 hover:shadow-lg hover:shadow-primary/5 transition-all duration-300 cursor-pointer"
      ...
      <div className="flex items-start gap-4">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2 mb-1">
            ...
            {isVerified && (
              <span className="text-xs text-primary font-medium">{t('courier.verified')}</span>
            )}
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <span className="text-sm text-muted-foreground">
              {deliveries} {t('courier.deliveries')}
            </span>
          </div>
        </div>
      </div>
