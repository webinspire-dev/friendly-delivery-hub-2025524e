...
const translations: Record<Language, Record<string, string>> = {
  fr: {
    ...
    'couriers.viewAll': 'Voir tous les livreurs',
    ...
    'search.searchByCity': 'Rechercher par ville',
    'search.selectCity': 'Sélectionner une ville',
    'search.nearbyMe': 'À proximité',
    'search.allCouriers': 'Tous les livreurs',
  ...
  ar: {
    ...
    'couriers.viewAll': 'شوف كاع الليفرورات',
    ...
    'search.searchByCity': 'قلّب بالمدينة',
    'search.selectCity': 'ختار مدينة',
    'search.nearbyMe': 'قريب مني',
    'search.allCouriers': 'كاع الليفرورات',
    'search.locating': 'كنحدد الموقع...',
